...
def main():
    ...
    input_inputs.set_data_from_numpy(
        input_tensor=np.array([[0, 1, 0, 2, 3, 4, 10, 6, 11, 7, 8, 9, 12, 0, 1, 4, 6247, 6246, 6246, 6246,6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246, 6246]], dtype=np.int64),
        binary_data=True,
    )
